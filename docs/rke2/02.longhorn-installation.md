...
- 대상 클러스터는 [`./01.installation.md`](./01.installation.md) 기준으로 이미 구축되어 있습니다.
...
[`./01.installation.md`](./01.installation.md)에서 모든 노드 공통 준비 항목으로 먼저 수행합니다.
...
- Kubernetes 기본 설치: [`./01.installation.md`](./01.installation.md)
