...
- Intel AMT Web UI: `http://192.168.77.254:16992/logon.htm`
...
```bash
TARGETS="192.168.77.254 192.168.77.253"
PORT="16992"
...
- 관리 IP가 `192.168.77.254`로 고정되어 있는지 확인
...
- 장애 시 `AMT DOWN on 192.168.77.254:16992`
- 복구 시 `AMT UP on 192.168.77.254:16992`
