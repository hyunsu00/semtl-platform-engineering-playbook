...
- 관리/서비스 브리지: `vmbr0` (`192.168.77.241/24`, gateway `192.168.77.1`)
...
| `vmbr0` 주소 | `192.168.77.241/24` |
| `vmbr0` 게이트웨이 | `192.168.77.1` |
...
- Kubernetes 운영: `docs/rke2/01.installation.md`
